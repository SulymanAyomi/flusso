      ...
      <Card className=" bg-green-100 text-green-900 flex flex-col gap-6 py-6 shadow-sm">
        ...
        <CardContent className="px-3 py-0 flex justify-between">
          <div className="flex flex-col gap-1">
            ...
            <div className="text-xs">Task completed this week</div>
          </div>
          <div>
            <div className="text-xs flex flex-col items-start">
        ...
        <CardFooter className="px-3 py-0">
          <div className="flex flex-1  items-center justify-between">
            <div className="bg-green-700 text-green-100 text-[10px] rounded-[6px] py-1.5 px-1 flex items-center">
              ...
              {analytics?.percentageChange}% more than last week
            </div>
          </div>
        </CardFooter>
      </Card>
        ...
        <CardHeader className="px-3 py-0">
          <div className="flex items-center justify-start">
            <div className="bg-yellow-700 text-yellow-100 rounded-full p-1 mr-2">
              <LucideCircleStop className="size-3.5" />
            </div>
            <div className="text-sm font-semibold">Blocked Task</div>
          </div>
        </CardHeader>
        <CardContent className="px-3 py-0 flex justify-between">
          <div className="flex flex-col gap-1">
            <div className="font-bold text-xl">2</div>
            <div className="text-xs">Currently blocked</div>
          </div>
        </CardContent>
        {/* <CardFooter className="px-3 py-0">
            <div className="flex flex-1  items-center justify-between">
