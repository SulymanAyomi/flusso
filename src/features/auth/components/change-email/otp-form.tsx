...
export function OTPForm({ vid, email, prevStep }: OTPFormProps) {
  ...
  return (
    <div className="bg-inherit flex flex-col items-center justify-center gap-3 p-6 py-0 md:p-10 md:pt-0">
      <div className="flex w-full max-w-sm flex-col gap-3">
        <Card className="w-full h-full border-none shadow-none pt-4">
