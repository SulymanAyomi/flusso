...
type LogActivityInput = {
    workspaceId: string
    memberId: string
    actionType: 'TASK_CREATED' | 'TASK_STATUS_UPDATED' | 'TASK_EDITED' | 'TASK_ASSIGNED' | 'PROJECT_CREATED' | 'PROJECT_COMPLETED' | 'PROJECT_EDITED' | 'PROJECT_STATUS_UPDATED' | 'COMMENT_ADDED' | 'SUBTASK_ADDED' | 'JOINED_WORKSPACE' | 'LEFT_WORKSPACE'
